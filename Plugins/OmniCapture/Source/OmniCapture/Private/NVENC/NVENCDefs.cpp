...
namespace OmniNVENC
{
    ...
    const FGuid& FNVENCDefs::PresetHighPerformanceGuid()
    {
    ...
    const FGuid& FNVENCDefs::PresetLowLatencyHighPerformanceGuid()
    {
    ...
    const FGuid& FNVENCDefs::PresetLowLatencyDefaultGuid()
    {
    ...
    const FGuid& FNVENCDefs::PresetLosslessHighPerformanceGuid()
    {
    ...
    const FGuid& FNVENCDefs::PresetHighQualityGuid()
    {
    ...
    const FGuid& FNVENCDefs::PresetLosslessDefaultGuid()
    {
    ...
    const FGuid& FNVENCDefs::PresetBestQualityGuid()
    {
    ...
    FString FNVENCDefs::PresetGuidToString(const FGuid& Guid)
    {
        ...
        if (Guid == PresetHighPerformanceGuid())
        {
            return TEXT("NV_ENC_PRESET_HP");
        }
        if (Guid == PresetLowLatencyHighPerformanceGuid())
        {
            return TEXT("NV_ENC_PRESET_LOW_LATENCY_HP");
        }
        if (Guid == PresetLowLatencyDefaultGuid())
        {
            return TEXT("NV_ENC_PRESET_LOW_LATENCY_DEFAULT");
        }
        if (Guid == PresetLosslessHighPerformanceGuid())
        {
            return TEXT("NV_ENC_PRESET_LOSSLESS_HP");
        }
        if (Guid == PresetHighQualityGuid())
        {
            return TEXT("NV_ENC_PRESET_HQ");
        }
        if (Guid == PresetLosslessDefaultGuid())
        {
            return TEXT("NV_ENC_PRESET_LOSSLESS_DEFAULT");
        }
        if (Guid == PresetBestQualityGuid())
        {
            return TEXT("NV_ENC_PRESET_BEST_QUALITY");
        }
